...
//     diagrams/slides 60,62  - idi will be returned and stored
   ...
   //semaphorei - refer to 11_ipcs_2.txt     
   ...
   //semaphore objecti - refer to 11_ipcs_2.txt  
