...
int main()
{
  ...
  //KEY value should be same, as that of producer program
  ...
  //we are getting the handle/id to the same semaphore object/
  //semaphores used, in producer 
  // 
  ...
  //however, producer's shared memory segment and 
  //consumer's shared memory segment point to 
  //the same shared-memory object/its page-frames -
  //much of this processing is done, in the background.... 
  //
  ...
  //do not initialize semaphores,again - they are already 
  //initialized, in the producer
  //do not initialize shared-memory application data/IPC data - 
  //since already initialized,  in the producer
